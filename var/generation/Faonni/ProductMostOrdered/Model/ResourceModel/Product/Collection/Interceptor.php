<?php
namespace Faonni\ProductMostOrdered\Model\ResourceModel\Product\Collection;

/**
 * Interceptor class for @see \Faonni\ProductMostOrdered\Model\ResourceModel\Product\Collection
 */
class Interceptor extends \Faonni\ProductMostOrdered\Model\ResourceModel\Product\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addOrdersCount($from = '', $to = '')
    {
        ...
        if (!$pluginInfo) {
            return parent::addOrdersCount($from, $to);
        } else {
