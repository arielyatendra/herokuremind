<?php
namespace Faonni\ProductMostOrdered\Block\ProductList;

/**
 * Interceptor class for @see \Faonni\ProductMostOrdered\Block\ProductList
 */
class Interceptor extends \Faonni\ProductMostOrdered\Block\ProductList implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPeriod');
        if (!$pluginInfo) {
            return parent::getPeriod();
        } else {
            return $this->___callPlugins('getPeriod', func_get_args(), $pluginInfo);
        }
    }
