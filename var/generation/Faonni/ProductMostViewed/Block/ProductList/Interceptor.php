...
/**
 * Interceptor class for @see \Faonni\ProductMostViewed\Block\ProductList
 */
class Interceptor extends \Faonni\ProductMostViewed\Block\ProductList implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Magento\Framework\Module\Manager $moduleManager, \Magento\Framework\Registry $registry, \Faonni\ProductMostViewed\Model\ResourceModel\Reports\Product\CollectionFactory $productsFactory, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFromTo');
        if (!$pluginInfo) {
            return parent::getFromTo();
        } else {
            return $this->___callPlugins('getFromTo', func_get_args(), $pluginInfo);
        }
    }
